...
<div class="container">
    ...
    <div class="table-container">
        <table class="table">
            <thead>
                <tr>
                    <th><i class="fas fa-rocket me-2"></i>Titre</th>
            ...
            <tbody>
                @foreach($projets as $projet)
                    <tr>
                        ...
                        <td>
                            <i class="fas fa-info me-1"></i>{{ Str::limit($projet->description, 50) ?? 'Aucune description' }}
                        </td>
                        <td>
                            <i class="fas fa-calendar me-1"></i>{{ \Carbon\Carbon::parse($projet->date_creation)->format('d/m/Y') }}
                        </td>
                        <td>
                            <i class="fas fa-euro-sign me-1"></i>{{ $projet->budget ?? 'Non défini' }}€
                        </td>
                        <td>
                            <span class="badge-status">
                                <i class="fas fa-check-circle me-1"></i>{{ $projet->statut ?? 'En cours' }}
                            </span>
                        </td>
                        <td>
                            <a href="{{ route('admin.projets.show', $projet) }}" class="btn btn-info btn-sm">
                                <i class="fas fa-eye me-1"></i>Voir
                            </a>
                            <a href="{{ route('admin.projets.edit', $projet) }}" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit me-1"></i>Modifier
                            </a>
                            <form action="{{ route('admin.projets.destroy', $projet) }}" method="POST" style="display:inline-block">
                                @csrf
                                @method('DELETE')
