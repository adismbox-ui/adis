...
@endif
    ...
    <div class="table-container">
        <table class="table">
            <thead>
                <tr>
                    <th><i class="fas fa-book me-2"></i>Titre</th>
        ...
        <tr>
                        ...
                        <td>
                            <span class="badge-niveau">
                                <i class="fas fa-layer-group me-1"></i>{{ $module->niveau->nom ?? 'N/A' }}
                            </span>
                        </td>
                        <td>
                            <i class="fas fa-info me-1"></i>{{ Str::limit($module->description, 50) ?? 'Aucune description' }}
                        </td>
                        <td>
                            <i class="fas fa-euro-sign me-1"></i>{{ $module->prix ?? 'Gratuit' }}€
                        </td>
                        <td>
                            <a href="{{ route('admin.modules.show', $module) }}" class="btn-action" title="Voir">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.modules.edit', $module) }}" class="btn-action" title="Modifier">
                    ...
                    @method('DELETE')
                                <button type="submit" class="btn-action" 
                                        onclick="return confirm('⚠️ Êtes-vous sûr de vouloir supprimer ce module ?')" title="Supprimer">
