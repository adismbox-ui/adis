                    ...
                    <th><i class="fas fa-cogs me-2"></i>Actions</th>
                        ...
                        <td>
                            ...
                            <i class="fas fa-stop me-1"></i>{{ \Carbon\Carbon::parse($session->date_fin)->format('d/m/Y') }}
                                    ...
                                    <td>
                            <i class="fas fa-users me-1"></i>{{ $session->capacite ?? 'Illimitée' }}
                                    </td>
                                    <td>
                            <span class="badge-status">
                                <i class="fas fa-check-circle me-1"></i>{{ $session->statut ?? 'Active' }}
                            </span>
                                    </td>
                                    <td>
                            <a href="{{ route('admin.sessions.show', $session) }}" class="btn-action" title="Voir">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.sessions.edit', $session) }}" class="btn-action" title="Modifier">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.sessions.destroy', $session) }}" method="POST" style="display:inline-block">
                                                @csrf
                                                @method('DELETE')
                                <button type="submit" class="btn-action" 
                                        onclick="return confirm('⚠️ Êtes-vous sûr de vouloir supprimer cette session ?')" title="Supprimer">
