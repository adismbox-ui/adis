    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="content-area card-3d">
                <h1 class="main-title">
                    <i class="fas fa-rocket me-3"></i>PROJETS EN COURS
                </h1>
                <div class="description">
                    <p class="lead mb-0">
                        <i class="fas fa-star text-warning me-2"></i>
                        Voici les projets passionnants que nous sommes fiers de réaliser grâce à la solidarité de notre communauté. Chaque initiative a un impact concret sur la vie des bénéficiaires, et votre soutien peut faire toute la différence. Explorez ces projets, suivez leur progression, et rejoignez-nous pour construire ensemble un avenir meilleur!
                        ...
                        <table class="table table-dark mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th><i class="fas fa-bullseye me-2"></i>Objectif du projet</th>
                                    <th><i class="fas fa-calendar-alt me-2"></i>Début</th>
                                    <th><i class="fas fa-calendar-check me-2"></i>Fin prévue</th>
                                ...
                                @if($projets->count() > 0)
                                    @foreach($projets as $projet)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="progress">
                                                    <div class="progress-bar" role="progressbar" style="width: {{ $projet->taux_avancement }}%">
                                                        {{ $projet->taux_avancement }}%
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{ $projet->responsable }}</td>
                                            <td>
                                                <span class="badge bg-{{ $projet->statut == 'en_cours' ? 'primary' : ($projet->statut == 'realise' ? 'success' : 'warning') }}">
...
@push('styles')
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .progress-bar { background: linear-gradient(90deg, var(--secondary-green), var(--accent-green)); border-radius: 10px; position: relative; overflow: hidden; animation: progressShine 2s ease-in-out infinite; }
