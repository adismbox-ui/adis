    ...
    <div class="table-container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <form method="GET" action="{{ route('utilisateurs.index') }}" class="d-flex" role="search">
                <input type="text" class="form-control me-2" name="q" value="{{ request('q') }}" placeholder="Rechercher (nom, prénom, email, téléphone)">
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><i class="fas fa-crown me-2"></i>Type</th>
            ...
            <tbody>
                @foreach($utilisateurs as $utilisateur)
                    <tr>
                        <td>
                            <strong>{{ $utilisateur->prenom }}</strong>
                        </td>
                        <td>
                            <strong>{{ $utilisateur->nom }}</strong>
                        </td>
                        <td>
                            <i class="fas fa-at me-1"></i>{{ $utilisateur->email }}
                        </td>
                        <td>
                            <span class="badge-type">
                                <i class="fas fa-shield-alt me-1"></i>{{ $utilisateur->type_compte }}
                            </span>
                        </td>
                        <td>
                            <a href="{{ route('utilisateurs.show', $utilisateur) }}" class="btn-action" title="Voir">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('utilisateurs.edit', $utilisateur) }}" class="btn-action" title="Modifier">
                            ...
                            <form action="{{ route('utilisateurs.destroy', $utilisateur) }}" method="POST" style="display:inline-block">
                                ...
                                <button type="submit" class="btn-action" 
                                        onclick="return confirm('⚠️ Êtes-vous sûr de vouloir supprimer cet utilisateur ?')" title="Supprimer">
